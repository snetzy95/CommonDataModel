--postgresql CDM Primary Key Constraints for OMOP Common Data Model 6.0
...
ALTER TABLE @cdmDatabaseSchema.SURVEY_CONDUCT ADD CONSTRAINT xpk_SURVEY_CONDUCT PRIMARY KEY (survey_conduct_id);
