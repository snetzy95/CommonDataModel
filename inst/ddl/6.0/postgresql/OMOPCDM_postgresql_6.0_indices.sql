...
CREATE INDEX idx_survey_person_id_1  ON @cdmDatabaseSchema.survey_conduct  (person_id ASC);
CLUSTER @cdmDatabaseSchema.survey_conduct  USING idx_survey_person_id_1 ;
CREATE INDEX idx_episode_person_id_1  ON @cdmDatabaseSchema.episode  (person_id ASC);
CLUSTER @cdmDatabaseSchema.episode  USING idx_episode_person_id_1 ;
CREATE INDEX idx_episode_concept_id_1 ON @cdmDatabaseSchema.episode (episode_concept_id ASC);
CREATE INDEX idx_episode_event_id_1  ON @cdmDatabaseSchema.episode_event  (episode_id ASC);
CLUSTER @cdmDatabaseSchema.episode_event  USING idx_episode_event_id_1 ;
