--bigquery CDM DDL Specification for OMOP Common Data Model 6.0
...
create table @cdmDatabaseSchema.visit_detail (
			...
			admitted_from_source_value INT64 not null,
			discharge_to_source_value STRING,
			discharge_to_concept_id INT64 not null,
...
create table @cdmDatabaseSchema.survey_conduct (
			...
			validated_survey_source_value INT64,
...
create table @cdmDatabaseSchema.payer_plan_period (
			...
			contract_source_value STRING not null,
