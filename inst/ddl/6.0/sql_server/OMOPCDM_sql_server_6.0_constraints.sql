--sql server CDM Foreign Key Constraints for OMOP Common Data Model 6.0
...
ALTER TABLE @cdmDatabaseSchema.VISIT_DETAIL ADD CONSTRAINT fpk_VISIT_DETAIL_admitted_from_source_value FOREIGN KEY (admitted_from_source_value) REFERENCES @cdmDatabaseSchema.CONCEPT (CONCEPT_ID);
...
ALTER TABLE @cdmDatabaseSchema.SURVEY_CONDUCT ADD CONSTRAINT fpk_SURVEY_CONDUCT_person_id FOREIGN KEY (person_id) REFERENCES @cdmDatabaseSchema.PERSON (PERSON_ID);
ALTER TABLE @cdmDatabaseSchema.SURVEY_CONDUCT ADD CONSTRAINT fpk_SURVEY_CONDUCT_survey_concept_id FOREIGN KEY (survey_concept_id) REFERENCES @cdmDatabaseSchema.CONCEPT (CONCEPT_ID);
ALTER TABLE @cdmDatabaseSchema.SURVEY_CONDUCT ADD CONSTRAINT fpk_SURVEY_CONDUCT_provider_id FOREIGN KEY (provider_id) REFERENCES @cdmDatabaseSchema.PROVIDER (PROVIDER_ID);
ALTER TABLE @cdmDatabaseSchema.SURVEY_CONDUCT ADD CONSTRAINT fpk_SURVEY_CONDUCT_assisted_concept_id FOREIGN KEY (assisted_concept_id) REFERENCES @cdmDatabaseSchema.CONCEPT (CONCEPT_ID);
ALTER TABLE @cdmDatabaseSchema.SURVEY_CONDUCT ADD CONSTRAINT fpk_SURVEY_CONDUCT_respondent_type_concept_id FOREIGN KEY (respondent_type_concept_id) REFERENCES @cdmDatabaseSchema.CONCEPT (CONCEPT_ID);
ALTER TABLE @cdmDatabaseSchema.SURVEY_CONDUCT ADD CONSTRAINT fpk_SURVEY_CONDUCT_timing_concept_id FOREIGN KEY (timing_concept_id) REFERENCES @cdmDatabaseSchema.CONCEPT (CONCEPT_ID);
ALTER TABLE @cdmDatabaseSchema.SURVEY_CONDUCT ADD CONSTRAINT fpk_SURVEY_CONDUCT_collection_method_concept_id FOREIGN KEY (collection_method_concept_id) REFERENCES @cdmDatabaseSchema.CONCEPT (CONCEPT_ID);
ALTER TABLE @cdmDatabaseSchema.SURVEY_CONDUCT ADD CONSTRAINT fpk_SURVEY_CONDUCT_survey_source_concept_id FOREIGN KEY (survey_source_concept_id) REFERENCES @cdmDatabaseSchema.CONCEPT (CONCEPT_ID);
ALTER TABLE @cdmDatabaseSchema.SURVEY_CONDUCT ADD CONSTRAINT fpk_SURVEY_CONDUCT_validated_survey_concept_id FOREIGN KEY (validated_survey_concept_id) REFERENCES @cdmDatabaseSchema.CONCEPT (CONCEPT_ID);
ALTER TABLE @cdmDatabaseSchema.SURVEY_CONDUCT ADD CONSTRAINT fpk_SURVEY_CONDUCT_visit_occurrence_id FOREIGN KEY (visit_occurrence_id) REFERENCES @cdmDatabaseSchema.VISIT_OCCURRENCE (VISIT_OCCURRENCE_ID);
ALTER TABLE @cdmDatabaseSchema.SURVEY_CONDUCT ADD CONSTRAINT fpk_SURVEY_CONDUCT_response_visit_occurrence_id FOREIGN KEY (response_visit_occurrence_id) REFERENCES @cdmDatabaseSchema.VISIT_OCCURRENCE (VISIT_OCCURRENCE_ID);
...
ALTER TABLE @cdmDatabaseSchema.PAYER_PLAN_PERIOD ADD CONSTRAINT fpk_PAYER_PLAN_PERIOD_contract_person_id FOREIGN KEY (contract_person_id) REFERENCES @cdmDatabaseSchema.PERSON (PERSON_ID);
...
ALTER TABLE @cdmDatabaseSchema.PAYER_PLAN_PERIOD ADD CONSTRAINT fpk_PAYER_PLAN_PERIOD_contract_concept_id FOREIGN KEY (contract_concept_id) REFERENCES @cdmDatabaseSchema.CONCEPT (CONCEPT_ID);
ALTER TABLE @cdmDatabaseSchema.PAYER_PLAN_PERIOD ADD CONSTRAINT fpk_PAYER_PLAN_PERIOD_contract_source_concept_id FOREIGN KEY (contract_source_concept_id) REFERENCES @cdmDatabaseSchema.CONCEPT (CONCEPT_ID);
...
ALTER TABLE @cdmDatabaseSchema.COST ADD CONSTRAINT fpk_COST_cost_event_field_concept_id FOREIGN KEY (cost_event_field_concept_id) REFERENCES @cdmDatabaseSchema.CONCEPT (CONCEPT_ID);
ALTER TABLE @cdmDatabaseSchema.COST ADD CONSTRAINT fpk_COST_cost_concept_id FOREIGN KEY (cost_concept_id) REFERENCES @cdmDatabaseSchema.CONCEPT (CONCEPT_ID);
...
ALTER TABLE @cdmDatabaseSchema.COST ADD CONSTRAINT fpk_COST_cost_source_concept_id FOREIGN KEY (cost_source_concept_id) REFERENCES @cdmDatabaseSchema.CONCEPT (CONCEPT_ID);
